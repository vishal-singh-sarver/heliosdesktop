...
describe('HomePage', () => {
  ...
  describe('create — latitude validation', () => {
    ...
    it('latitude with exactly 7 decimals (89.1234567, in range) is ACCEPTED — create succeeds', async () => {
      ...
      // is < 90 so it is in range — this isolates the 7-decimal-precision rule. If
      // the decimal-count rule were wrongly strict at 7 places, the dialog would
  ...
  describe('create — longitude validation', () => {
    ...
    it('longitude with exactly 7 decimals (179.1234567, in range) is ACCEPTED — create succeeds', async () => {
      // Acceptance, not "no-error": full valid submit with lon < 180 AND exactly 7
      // decimals must pass and navigate away (isolates the 7-decimal-precision
      // rule). A wrongly-strict decimal rule (>=7 reject) would keep the dialog
      // open -> red.
      await HomePage.openCreateDialogViaSidebar()
...
describe('Recent Projects', () => {
  ...
  describe('search — special characters', () => {
    it('regex-meta characters in the search box filter literally without crashing', async () => {
    ...
    it('a special-character substring filters to its matching project', async () => {
  ...
  describe('delete — multiple & permanence', () => {
    it('several own projects delete sequentially, each row removed independently', async () => {
    ...
    it('confirm permanently removes the project (row absent after a re-fetch)', async () => {
    ...
    it('a deleted project does not reappear after reloadToHome', async () => {
  ...
  describe('delete — concurrency guards', () => {
    it('double-clicking the kebab Delete item opens exactly one delete dialog', async () => {
    ...
    it('refreshing while the delete dialog is open performs no deletion', async () => {
  ...
  describe('scale', () => {
    it('many own projects render and stay responsive (virtualized list)', async () => {
